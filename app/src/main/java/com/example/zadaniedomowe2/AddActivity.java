        ...
        View.OnClickListener myClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(nameString) && !TextUtils.isEmpty(nameString) && !TextUtils.isEmpty(dateString)){
                    ...
                    if(TextUtils.isEmpty(nameString)) name.setError("Dodaj nazwe wydarzenia");
                    if(TextUtils.isEmpty(detailsString)) details.setError("Dodaj szczegoly wydarzenia");
                    if(TextUtils.isEmpty(dateString)) date.setError("Dodaj date wydarzenia");
                }
            }
        };
