package com.example.zadaniedomowe2;
...
import com.example.zadaniedomowe2.events.EventContent;

import static com.example.zadaniedomowe2.events.EventContent.addItem;
import static com.example.zadaniedomowe2.events.EventContent.createEvent;
...
public class MainActivity extends AppCompatActivity implements EventFragment.OnListFragmentInteractionListener {
    ...
    private void deleteItem(final int position) {
        new AlertDialog.Builder(this)
                .setTitle("Potwierdz")
                .setMessage("Czy na pewno chcesz usunac to wydarzenie?")
